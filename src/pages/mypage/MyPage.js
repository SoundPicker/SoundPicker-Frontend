            ...
            <Wrapper>
              ...
              <Content>
                <Input
                  ...
                  bordered={false}
                  name="email"
                  value={myState.member.email}
                  disabled={true}
                />
                <Button2 font="12" color="gray">
                  이메일 <div></div>변경불가
                </Button2>
              </Content>
              <BlankTop DesktopMargin="5" TabletMargin="5" MobileMargin="1" />
                  ...
                  <div>
                    <Detail>
                      ...
                      <div>
                        <Button
                          font="12"
                          onClick={() => history.push(`/testedit/${member.id}`)}
                        >
                          수정
                        </Button>
                        <Button font="12" onClick={() => onDeleteTest(member)}>
                          삭제
                        </Button>
                        <Button
                          font="12"
                          color="#60FFDA"
                          border="#60FFDA"
                          onClick={() => history.push(`/test/${member.id}`)}
                        >
                          {" "}
                          플레이
                        </Button>{" "}
